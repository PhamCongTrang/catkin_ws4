...
if("TRUE" STREQUAL "TRUE")
  set(chapter6_SOURCE_PREFIX /home/trang/catkin_ws4/src/chapter6)
  set(chapter6_DEVEL_PREFIX /home/trang/catkin_ws4/devel)
  set(chapter6_INSTALL_PREFIX "")
  set(chapter6_PREFIX ${chapter6_DEVEL_PREFIX})
else()
  set(chapter6_SOURCE_PREFIX "")
  set(chapter6_DEVEL_PREFIX "")
  set(chapter6_INSTALL_PREFIX /home/trang/catkin_ws4/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'trang <trang@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'chapter6' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/trang/catkin_ws4/src/chapter6/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT chapter6_NUM_DUMMY_TARGETS)
      set(chapter6_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::chapter6::wrapped-linker-option${chapter6_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR chapter6_NUM_DUMMY_TARGETS "${chapter6_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::chapter6::wrapped-linker-option${chapter6_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND chapter6_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(chapter6_EXPORTED_TARGETS ${${chapter6_dep}_EXPORTED_TARGETS})
endforeach()
